...
/**
 * Episode 색인을 위한 원천 데이터.
 */
data class EpisodeIndexSource(
    val id: Long,
    val workId: Long,
    val title: String,
    val seq: Int,
